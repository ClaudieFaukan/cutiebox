        ...
        <div class="col-md-8 col-sm-8 mx-auto text-center" style="padding-top:2%; display: none;width:100%" id="step-3" >
            ...
            <input type="file" id="image" style="width:100%; display:none">
                ...
                <!-- CROPPIE IMAGE #STEP-2-->
                    <div class="container col-12 row justify-content-center" id="step-2" style="display:none; padding-top: 2%;border:none;height:50%">
                        <div class="card" style= "border:none">
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8 mx-auto text-center row align-content-center" style="padding-top:3%;width:100%; display: none;" id="rotate">
                        <p style="font-size: 1.8em; color:white">Changer l'orientation de votre photo</p>
                    ...
                    <span style="color:white; font-size:1.6em ; color:white">Entrer votre adresse  pour imprimer votre souvenir</span>
